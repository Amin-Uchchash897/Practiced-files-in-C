...
// Write C program to find square of a number with function.
...
void squareResultOfInput(int x)
{
    int squareOfNumber;
...
int squareRootResultOfInput(int y)
{
    int squareRootOfNumber = sqrt(y);
...
int main()
{
    ...
    squareResultOfInput(numberOne);
    squareResultOfInput(numberTwo);
    printf("The Square Root of %d = %d\n", numberThree, squareRootResultOfInput(numberThree));
